    ...
    return (
        <main className="flex min-h-screen flex-col items-center justify-between p-24 bg-black">
            <div className="container mx-auto px-4 py-8 text-white">
                ...
                <p className="mb-4">Last updated: July 05, 2025</p>
                <p className="mb-4">
                ...
                <ul className="list-disc list-outside mb-4 pl-4">
                    ...
                    <li>
                        <p className="mb-2">
                            <strong>Country</strong> refers to: Missouri, United
                            States
                        </p>
                    </li>
                    <li>
                    ...
                    <li>
                        <p className="mb-2">
                            <strong>Website</strong> refers to MeowgicWare,
                            accessible from{' '}
                            <a
                                href="https://meowgicware.com"
                                rel="external nofollow noopener"
                                target="_blank"
                                className="text-blue-500 hover:underline"
                            >
                                https://meowgicware.com
                            </a>
                        </p>
                    </li>
                    <li>
                ...
                <ul className="list-disc list-outside mb-4 pl-4">
                    ...
                    <li>
                        <p className="mb-2">First name and last name</p>
                    </li>
                    <li>
                        <p className="mb-2">Address, State, Province, ZIP/Postal code, City</p>
                    </li>
                    <li>
                ...
                <h3 className="text-xl font-bold mt-6 mb-2">Retention of Your Personal Data</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mt-6 mb-2">Delete Your Personal Data</h3>
                <p className="mb-4">
                ...
                <h3 className="text-xl font-bold mt-6 mb-2">Disclosure of Your Personal Data</h3>
                ...
                <h3 className="text-xl font-bold mt-6 mb-2">Security of Your Personal Data</h3>
                <p className="mb-4">
